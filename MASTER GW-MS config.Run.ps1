...
# Source File: E:\GIT-LOCAL-REPOSITORIES\DTEK_SCOM_GATEWAY_CONSOLE\DTEK_SCOM_GATEWAY_CONSOLE\MASTER GW-MS config.psf
#------------------------------------------------------------------------
...
"@ -IgnoreWarnings | Out-Null
	...
	$formSCOMGATEWAYANALYSIST = New-Object 'System.Windows.Forms.Form'
	$labelConsoleStatus = New-Object 'System.Windows.Forms.Label'
	$panel1 = New-Object 'System.Windows.Forms.Panel'
	$labelNameContains = New-Object 'System.Windows.Forms.Label'
	$labelIPSubnet = New-Object 'System.Windows.Forms.Label'
	$labelDatacenterSort = New-Object 'System.Windows.Forms.Label'
	$checkboxEnable = New-Object 'System.Windows.Forms.CheckBox'
	$textbox12 = New-Object 'System.Windows.Forms.TextBox'
	$textbox11 = New-Object 'System.Windows.Forms.TextBox'
	$labelSElectManagementGrou = New-Object 'System.Windows.Forms.Label'
	$checkedlistbox7 = New-Object 'System.Windows.Forms.CheckedListBox'
	...
	$buttonSTARTGATEWAYSCAN_Click= {
		$formSCOMGATEWAYANALYSIST.Refresh
		$buttonSTARTGATEWAYSCAN.backcolor = "Orange"
		...
		##// ADD LOGGING FUNCTION from templates
		...
		If ($STATUS -ne "FAILED")
		{
			$LogMessages += '--CONNECTING to MG' + $Global:NewLine
			try
			{
				
				#// insert SPN discovery function here		
				#// 
				
				$ManagementServers = ""
				
				#//TEST//#
				$MS1 = "DTEKSC2016-m1.dtek.com"
				$MS2 = "DTEKSC2016-m2.dtek.com"
				$MS3 = "DTEKSC2016-m3.dtek.com"
			...
			##// DataCenter Sort analysis based on IP and /or Name
		...
		$buttonSTARTGATEWAYSCAN.backcolor = "Lime"
		$panel1.BackColor = "Red"
		$panel1.text = "ERROR"
	}
	###################################################################################	
	...
	$buttonEXITCONSOLE_Click={$formSCOMGATEWAYANALYSIST.Close()}
	...
	$labelSElectManagementGrou_Click={
		#TODO: Place custom script here
	...
	$Form_StateCorrection_Load=
	{
		...
		$formSCOMGATEWAYANALYSIST.WindowState = $InitialFormWindowState
	}
	...
	$Form_Cleanup_FormClosed=
	{
		...
		try
		{
			$labelSElectManagementGrou.remove_Click($labelSElectManagementGrou_Click)
			...
			$formSCOMGATEWAYANALYSIST.remove_Load($formSCOMGATEWAYANALYSIST_Load)
			$formSCOMGATEWAYANALYSIST.remove_Load($Form_StateCorrection_Load)
			$formSCOMGATEWAYANALYSIST.remove_FormClosed($Form_Cleanup_FormClosed)
		}
	...
	#----------------------------------------------
	$formSCOMGATEWAYANALYSIST.SuspendLayout()
	#
	# formSCOMGATEWAYANALYSIST
	#
	$formSCOMGATEWAYANALYSIST.Controls.Add($labelConsoleStatus)
	$formSCOMGATEWAYANALYSIST.Controls.Add($panel1)
	$formSCOMGATEWAYANALYSIST.Controls.Add($labelNameContains)
	$formSCOMGATEWAYANALYSIST.Controls.Add($labelIPSubnet)
	$formSCOMGATEWAYANALYSIST.Controls.Add($labelDatacenterSort)
	$formSCOMGATEWAYANALYSIST.Controls.Add($checkboxEnable)
	$formSCOMGATEWAYANALYSIST.Controls.Add($textbox12)
	$formSCOMGATEWAYANALYSIST.Controls.Add($textbox11)
	$formSCOMGATEWAYANALYSIST.Controls.Add($labelSElectManagementGrou)
	$formSCOMGATEWAYANALYSIST.Controls.Add($checkedlistbox7)
	$formSCOMGATEWAYANALYSIST.Controls.Add($label7)
	$formSCOMGATEWAYANALYSIST.Controls.Add($textbox10)
	$formSCOMGATEWAYANALYSIST.Controls.Add($button1)
	$formSCOMGATEWAYANALYSIST.Controls.Add($buttonSHOWAGENTS)
	$formSCOMGATEWAYANALYSIST.Controls.Add($buttonSHOWGWFAILOVER)
	$formSCOMGATEWAYANALYSIST.Controls.Add($labelDataCenter3)
	$formSCOMGATEWAYANALYSIST.Controls.Add($listbox3)
	$formSCOMGATEWAYANALYSIST.Controls.Add($progressbaroverlay1)
	$formSCOMGATEWAYANALYSIST.Controls.Add($SETALLB)
	$formSCOMGATEWAYANALYSIST.Controls.Add($SETALLA)
	$formSCOMGATEWAYANALYSIST.Controls.Add($labelAGENTS)
	$formSCOMGATEWAYANALYSIST.Controls.Add($checkedlistbox6)
	$formSCOMGATEWAYANALYSIST.Controls.Add($checkedlistbox5)
	$formSCOMGATEWAYANALYSIST.Controls.Add($buttonSELECT4)
	$formSCOMGATEWAYANALYSIST.Controls.Add($buttonSELECT3)
	$formSCOMGATEWAYANALYSIST.Controls.Add($buttonSELECT2)
	$formSCOMGATEWAYANALYSIST.Controls.Add($buttonSELECT1)
	$formSCOMGATEWAYANALYSIST.Controls.Add($textbox9)
	$formSCOMGATEWAYANALYSIST.Controls.Add($textbox8)
	$formSCOMGATEWAYANALYSIST.Controls.Add($label5)
	$formSCOMGATEWAYANALYSIST.Controls.Add($label4)
	$formSCOMGATEWAYANALYSIST.Controls.Add($label3)
	$formSCOMGATEWAYANALYSIST.Controls.Add($label2)
	$formSCOMGATEWAYANALYSIST.Controls.Add($label1)
	$formSCOMGATEWAYANALYSIST.Controls.Add($labelSELECTED)
	$formSCOMGATEWAYANALYSIST.Controls.Add($labelGATEWAYAndAGENTSTATU)
	$formSCOMGATEWAYANALYSIST.Controls.Add($STATUS)
	$formSCOMGATEWAYANALYSIST.Controls.Add($textbox7)
	$formSCOMGATEWAYANALYSIST.Controls.Add($textbox6)
	$formSCOMGATEWAYANALYSIST.Controls.Add($textbox5)
	$formSCOMGATEWAYANALYSIST.Controls.Add($textbox4)
	$formSCOMGATEWAYANALYSIST.Controls.Add($textbox3)
	$formSCOMGATEWAYANALYSIST.Controls.Add($textbox2)
	$formSCOMGATEWAYANALYSIST.Controls.Add($textbox1)
	$formSCOMGATEWAYANALYSIST.Controls.Add($buttonEXITCONSOLE)
	$formSCOMGATEWAYANALYSIST.Controls.Add($buttonSTARTGATEWAYSCAN)
	$formSCOMGATEWAYANALYSIST.Controls.Add($labelSCRIPTOUTPUT)
	$formSCOMGATEWAYANALYSIST.Controls.Add($buttonset4)
	$formSCOMGATEWAYANALYSIST.Controls.Add($checkedlistbox4)
	$formSCOMGATEWAYANALYSIST.Controls.Add($buttonSET2)
	$formSCOMGATEWAYANALYSIST.Controls.Add($checkedlistbox3)
	$formSCOMGATEWAYANALYSIST.Controls.Add($labelSETAGENTFAILOVER)
	$formSCOMGATEWAYANALYSIST.Controls.Add($buttonCHECKAGENTFAILOVER)
	$formSCOMGATEWAYANALYSIST.Controls.Add($SHOWAGENTSB)
	$formSCOMGATEWAYANALYSIST.Controls.Add($DCBGWFailover)
	$formSCOMGATEWAYANALYSIST.Controls.Add($labelSETGWFAILOVER)
	$formSCOMGATEWAYANALYSIST.Controls.Add($SHOWAGENTSFAILOVER)
	$formSCOMGATEWAYANALYSIST.Controls.Add($labelDTEKSCOMGATEWAYMANAG)
	$formSCOMGATEWAYANALYSIST.Controls.Add($buttonSET3)
	$formSCOMGATEWAYANALYSIST.Controls.Add($checkedlistbox2)
	$formSCOMGATEWAYANALYSIST.Controls.Add($checkedlistbox1)
	$formSCOMGATEWAYANALYSIST.Controls.Add($buttonSET1)
	$formSCOMGATEWAYANALYSIST.Controls.Add($SHOWAGENTSA)
	$formSCOMGATEWAYANALYSIST.Controls.Add($DCAGWFailover)
	$formSCOMGATEWAYANALYSIST.Controls.Add($labelDataCenter2)
	$formSCOMGATEWAYANALYSIST.Controls.Add($labelDatacenter1)
	$formSCOMGATEWAYANALYSIST.Controls.Add($listbox2)
	$formSCOMGATEWAYANALYSIST.Controls.Add($listbox1)
	$formSCOMGATEWAYANALYSIST.Controls.Add($picturebox1)
	$formSCOMGATEWAYANALYSIST.AutoScaleDimensions = '6, 13'
	$formSCOMGATEWAYANALYSIST.AutoScaleMode = 'Font'
	$formSCOMGATEWAYANALYSIST.ClientSize = '1333, 826'
	$formSCOMGATEWAYANALYSIST.Name = 'formSCOMGATEWAYANALYSIST'
	$formSCOMGATEWAYANALYSIST.Text = 'SCOM GATEWAY ANALYSIS TOOL'
	$formSCOMGATEWAYANALYSIST.add_Load($formSCOMGATEWAYANALYSIST_Load)
	#
	# labelConsoleStatus
	#
	$labelConsoleStatus.Font = 'Tahoma, 8pt, style=Bold'
	$labelConsoleStatus.Location = '645, 717'
	$labelConsoleStatus.Name = 'labelConsoleStatus'
	$labelConsoleStatus.Size = '107, 18'
	$labelConsoleStatus.TabIndex = 73
	$labelConsoleStatus.Text = 'CONSOLE STATUS
'
	$labelConsoleStatus.UseCompatibleTextRendering = $True
	#
	# panel1
	#
	$panel1.BackColor = 'Lime'
	$panel1.BorderStyle = 'FixedSingle'
	$panel1.Font = 'Microsoft Sans Serif, 12pt, style=Bold'
	$panel1.ForeColor = 'White'
	$panel1.Location = '628, 738'
	$panel1.Name = 'panel1'
	$panel1.Size = '138, 48'
	$panel1.TabIndex = 72
	#
	# labelNameContains
	#
	$labelNameContains.Enabled = $False
	$labelNameContains.Font = 'Tahoma, 7pt, style=Bold'
	$labelNameContains.Location = '1239, 75'
	$labelNameContains.Name = 'labelNameContains'
	$labelNameContains.Size = '82, 17'
	$labelNameContains.TabIndex = 71
	$labelNameContains.Text = 'Name Contains'
	$labelNameContains.UseCompatibleTextRendering = $True
	$labelNameContains.Visible = $False
	#
	# labelIPSubnet
	#
	$labelIPSubnet.Enabled = $False
	$labelIPSubnet.Font = 'Tahoma, 7pt, style=Bold'
	$labelIPSubnet.Location = '1239, 46'
	$labelIPSubnet.Name = 'labelIPSubnet'
	$labelIPSubnet.Size = '82, 19'
	$labelIPSubnet.TabIndex = 70
	$labelIPSubnet.Text = 'IP Subnet'
	$labelIPSubnet.UseCompatibleTextRendering = $True
	$labelIPSubnet.Visible = $False
	#
	# labelDatacenterSort
	#
	$labelDatacenterSort.Enabled = $False
	$labelDatacenterSort.Font = 'Tahoma, 8.25pt, style=Bold'
	$labelDatacenterSort.Location = '1044, 23'
	$labelDatacenterSort.Name = 'labelDatacenterSort'
	$labelDatacenterSort.Size = '122, 19'
	$labelDatacenterSort.TabIndex = 69
	$labelDatacenterSort.Text = 'Datacenter Sort
'
	$labelDatacenterSort.UseCompatibleTextRendering = $True
	$labelDatacenterSort.Visible = $False
	#
	# checkboxEnable
	#
	$checkboxEnable.Location = '1044, 41'
	$checkboxEnable.Name = 'checkboxEnable'
	$checkboxEnable.Size = '83, 24'
	$checkboxEnable.TabIndex = 68
	$checkboxEnable.Text = 'Enable'
	$checkboxEnable.UseCompatibleTextRendering = $True
	$checkboxEnable.UseVisualStyleBackColor = $True
	$checkboxEnable.Visible = $False
	#
	# textbox12
	#
	$textbox12.BackColor = 'InactiveCaption'
	$textbox12.Location = '1133, 75'
	...
	$textbox11.Location = '1133, 45'
	$textbox11.Name = 'textbox11'
	$textbox11.Size = '100, 20'
	$textbox11.TabIndex = 66
	$textbox11.Visible = $False
	#
	# labelSElectManagementGrou
	#
	$labelSElectManagementGrou.Enabled = $False
	$labelSElectManagementGrou.Font = 'Tahoma, 8.25pt, style=Bold'
	$labelSElectManagementGrou.Location = '874, 23'
	$labelSElectManagementGrou.Name = 'labelSElectManagementGrou'
	$labelSElectManagementGrou.Size = '164, 19'
	$labelSElectManagementGrou.TabIndex = 65
	$labelSElectManagementGrou.Text = 'Select management group'
	$labelSElectManagementGrou.UseCompatibleTextRendering = $True
	$labelSElectManagementGrou.Visible = $False
	$labelSElectManagementGrou.add_Click($labelSElectManagementGrou_Click)
	#
	# checkedlistbox7
	#
	$checkedlistbox7.BackColor = 'GradientActiveCaption'
	$checkedlistbox7.Enabled = $False
	$checkedlistbox7.FormattingEnabled = $True
	$checkedlistbox7.Location = '874, 45'
	$checkedlistbox7.Name = 'checkedlistbox7'
	$checkedlistbox7.Size = '152, 64'
	$checkedlistbox7.TabIndex = 64
	$checkedlistbox7.UseCompatibleTextRendering = $True
	...
	# progressbaroverlay1
	#
	$progressbaroverlay1.Location = '512, 72'
	...
	# checkedlistbox6
	#
	$checkedlistbox6.BackColor = 'GradientActiveCaption'
	...
	# checkedlistbox5
	#
	$checkedlistbox5.BackColor = 'GradientActiveCaption'
	...
	#
	$labelGATEWAYAndAGENTSTATU.Font = 'Tahoma, 8pt, style=Bold'
	$labelGATEWAYAndAGENTSTATU.Location = '792, 717'
	$labelGATEWAYAndAGENTSTATU.Name = 'labelGATEWAYAndAGENTSTATU'
	$labelGATEWAYAndAGENTSTATU.Size = '172, 18'
...
'
	...
	$STATUS.Font = 'Microsoft Sans Serif, 12pt, style=Bold'
	$STATUS.Location = '792, 738'
	$STATUS.Name = 'STATUS'
	$STATUS.Size = '172, 48'
	$STATUS.TabIndex = 37
	#
	...
	# textbox5
	#
	$textbox5.BackColor = 'GradientActiveCaption'
	...
	# textbox4
	#
	$textbox4.BackColor = 'GradientActiveCaption'
	...
	#
	$buttonSTARTGATEWAYSCAN.BackColor = 'YellowGreen'
	$buttonSTARTGATEWAYSCAN.Font = 'Arial, 8.25pt, style=Bold'
	$buttonSTARTGATEWAYSCAN.Location = '153, 56'
	...
	$buttonSTARTGATEWAYSCAN.UseVisualStyleBackColor = $False
	...
	# checkedlistbox4
	#
	$checkedlistbox4.BackColor = 'GradientActiveCaption'
	...
	# checkedlistbox3
	#
	$checkedlistbox3.BackColor = 'GradientActiveCaption'
	...
	# checkedlistbox2
	#
	$checkedlistbox2.BackColor = 'GradientActiveCaption'
	...
	# checkedlistbox1
	#
	$checkedlistbox1.BackColor = 'GradientActiveCaption'
...
ngIeJF5LYRlhRfNXjw0b/g/L9bHJEuSXPwAAAABJRU5ErkJggg==')
	...
	$formSCOMGATEWAYANALYSIST.ResumeLayout()
	#endregion Generated Form Code

	#----------------------------------------------

	#Save the initial state of the form
	$InitialFormWindowState = $formSCOMGATEWAYANALYSIST.WindowState
	#Init the OnLoad event to correct the initial state of the form
	$formSCOMGATEWAYANALYSIST.add_Load($Form_StateCorrection_Load)
	#Clean up the control events
	$formSCOMGATEWAYANALYSIST.add_FormClosed($Form_Cleanup_FormClosed)
	#Show the Form
	return $formSCOMGATEWAYANALYSIST.ShowDialog()
