...
"@ -IgnoreWarnings | Out-Null
	...
	$checkboxDCSortBy = New-Object 'System.Windows.Forms.CheckBox'
	...
	$formSCOMGATEWAYANALYSIST.Controls.Add($checkboxDCSortBy)
...
'
	...
	# checkboxDCSortBy
	#
	$checkboxDCSortBy.Location = '1044, 41'
	$checkboxDCSortBy.Name = 'checkboxDCSortBy'
	$checkboxDCSortBy.Size = '83, 24'
	$checkboxDCSortBy.TabIndex = 68
	$checkboxDCSortBy.Text = 'DC Sort By'
	$checkboxDCSortBy.UseCompatibleTextRendering = $True
	$checkboxDCSortBy.UseVisualStyleBackColor = $True
	$checkboxDCSortBy.Visible = $False
	#
	# textbox12
	#
