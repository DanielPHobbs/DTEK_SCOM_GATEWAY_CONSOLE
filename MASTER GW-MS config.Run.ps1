...
"@ -IgnoreWarnings | Out-Null
	...
	$textbox1.Text = $LogMessages
			...
			Try
			{
				Import-module OperationsManager -ErrorAction continue
			}
			catch
			{
	...
	$formSCOMGATEWAYANALYSIST.ClientSize = '1333, 795'
	...
	$labelConsoleStatus.Location = '444, 709'
...
'
	...
	$labelGATEWAYAndAGENTSTATU.Location = '591, 709'
